package com.ismaylov.javacodingproblems.chapter01.problem13;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------------------------------");
        try {
            JavaClass objectClazz = Repository.lookupClass("com.ismaylov.javacodingproblems.chapter01.problem13.Strings");
